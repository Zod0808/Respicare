...
const config = {
  ...
  collectCoverageFrom: [
    ...
    'lib/services/sqliteDatabase.ts',
    'lib/services/emulatorSensors.ts',
    'lib/services/healthConnectService.ts',
    'lib/services/wearableWebSocket.ts',
    'lib/services/bleWearableService.ts',
    'lib/api/services/wearableService.ts',
    '!**/*.d.ts',
    '!**/node_modules/**',
  ],
  coverageThreshold: {
